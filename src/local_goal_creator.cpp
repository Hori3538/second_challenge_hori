...
{
    double dist = sqrt(pow(estimated_pose.pose.position.x - global_path.poses[goal_index].pose.position.x, 2) + 
                       pow(estimated_pose.pose.position.y - global_path.poses[goal_index].pose.position.y, 2));
